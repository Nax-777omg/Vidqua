   ...
   $matricula = "isma nax,87,11,10,2023"; // se necesita agregar una matricula proporcionado por upload.php al subir video
   ...
   $vidmad = "141"; // se necesita proporcionar un vidmad proporcionado por upload.php a la hora de subir el video
