...
echo "Solo soportamos archivos de imagen para tu miniatura";
    ...
    move_uploaded_file($Miniatura, $DestinoMiniatura);
        ...
        $sql = "INSERT INTO videos (titulo, matricula, descripcion, miniatura, video, fecha) VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $mysqli->prepare($sql);
        ...
        $stmt->bind_param("ssssss", $title, $matricula, $description, $DestinoMiniatura, $DestinoVideo, $fecha);
