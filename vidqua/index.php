...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="css/index.css?=fffff            ">
<link rel="icon" href="multimedia/1.jpg">
<title>Vidqua</title>
</head>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<p  class=\"fontmin2\" >" . $row['nombre_de_usuario'] . "</p>"; // Accede a la clave 'nombre_de_usuario' del array $row
